...
class Student extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_flashdata('current_page','senarai pelajar'); // set for active sidebar
        $this->session->set_flashdata('typeAction','lihat senarai pelajar'); // set for user logs
