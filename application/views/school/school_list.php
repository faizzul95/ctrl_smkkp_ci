...
<head>
    ...
    <title> Senarai School | SMK Kinarut Papar</title>
    <!-- Global stylesheets -->
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                            ...
                            <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                                ...
                                <li class="nav-item"><a href="student" class="nav-link active">Senarai School <span class="badge bg-indigo-400 align-self-center ml-auto">534</span></a></li>
                            </ul>
                        </li>
                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <a href="#" class="breadcrumb-item">School</a>
                            <span class="breadcrumb-item active"> Senarai School</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Whole row as a control -->
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h2 class="card-title">SENARAI SCHOOL</h2>
                    ...
                    <div class="header-elements">
                         ...
                         <?php echo anchor(site_url('school/create'), '<span class="icon-user-plus"></span> Daftar School', 'class="btn btn-info ml-3"'); ?></div>
                    ...
                    <table id="mytable" class="table table-bordered table-striped datatable-responsive-row-control">
                        ...
                        <tr>
                            <th width="20px">No</th>
						    <th style="color: white">School Name</th>
						    <th style="color: white">School Address</th>
						    <th style="color: white">School Postal Code</th>
						    <th style="color: white">School City Id</th>
						    <th style="color: white">School State Id</th>
						    <th style="color: white">School Country Id</th>
						    <th style="color: white">School Type</th>
						    <th style="color: white">School Level</th>
...
<th style="color: white" width="250px">Tindakan</th>
    ...
    $(document).ready(function() {
        ...
        var t = $("#mytable").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "school/json", "type": "POST"},
            columns: [
                {
                    "data": "school_id",
                    "orderable": false
                },{"data": "school_name"},{"data": "school_address"},{"data": "school_postal_code"},{"data": "school_city_id"},{"data": "school_state_id"},{"data": "school_country_id"},{"data": "school_type"},{"data": "school_level"},{"data": "create_at"},{"data": "update_at"},
                {
                    "data" : "action",
                    "orderable": false,
