...
class Lib_log
{
    ...
    public function error_handler($severity, $message, $filepath, $line)
    {
        ...
        // error execption server
//         $e1 = "Undefined index: times ";
//         $e2 = "getimagesize(): http:// wrapper is disabled in the server configuration by allow_url_fopen=0";
//         $e3 = "file_get_contents(): http:// wrapper is disabled in the server configuration by allow_url_fopen=0
// ";

        // if ($message != $e1 || $message != $e2 || $message != $e3) {
                $data = array(
                'errno' => $severity,
